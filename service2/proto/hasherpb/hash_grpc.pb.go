...
const (
	HasherService_CalculateHashes_FullMethodName = "/hasher.HasherService/CalculateHashes"
)
...
type HasherServiceClient interface {
	// Получить список хэшей от переданных строк
	CalculateHashes(ctx context.Context, in *HashRequest, opts ...grpc.CallOption) (*HashResponse, error)
}
...
func (c *hasherServiceClient) CalculateHashes(ctx context.Context, in *HashRequest, opts ...grpc.CallOption) (*HashResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HashResponse)
	err := c.cc.Invoke(ctx, HasherService_CalculateHashes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HasherServiceServer interface {
	// Получить список хэшей от переданных строк
	CalculateHashes(context.Context, *HashRequest) (*HashResponse, error)
...
func (UnimplementedHasherServiceServer) CalculateHashes(context.Context, *HashRequest) (*HashResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CalculateHashes not implemented")
}
...
func _HasherService_CalculateHashes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HashRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HasherServiceServer).CalculateHashes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HasherService_CalculateHashes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HasherServiceServer).CalculateHashes(ctx, req.(*HashRequest))
	}
...
var HasherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CalculateHashes",
			Handler:    _HasherService_CalculateHashes_Handler,
		},
	},
